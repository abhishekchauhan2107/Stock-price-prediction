...
yf.pdr_override()
#Get the stock qoute
df = pdr.get_data_yahoo("AAPL", start="1986-01-01", end="2021-12-21")
...
#Get the Quote 
apple_quote = pdr.get_data_yahoo("AAPL", start="1986-01-01", end="2021-12-21")
...
apple_quote2 = pdr.get_data_yahoo("AAPL", start="2021-12-20", end="2021-12-21")
